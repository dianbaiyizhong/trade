package com.hhm.trade;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;

import com.hhm.trade.download.HttpUtil;
...
public class MainActivity extends Activity {
	...
	public void LoadTab1() {
		final ListView list = (ListView) findViewById(R.id.LV_tab);
		...
		new Thread() {
			...
			public void run() {
				...
				String result = httpUtil
						.getHttpJSON("http://192.168.1.109:8080/trade/Content");
		...
		final SimpleAdapter listItemAdapter = new SimpleAdapter(
				getApplicationContext(), listItem, R.layout.listview_tab1,
